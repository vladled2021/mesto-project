...
function handleFormCreateCard(evt) {          // функция добавления/удаления карточки, с данными из попапа
  evt.preventDefault();
...
function addArrayElement(arr) {                                                    // функция добавления/удаления карточки, с данными из массива
